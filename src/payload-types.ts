...
export interface ContentBlock {
  ...
  columns?:
    | {
        ...
        block?: (StandingsBlock | FeaturedPostBlock | MediaBlock | ArchiveBlock | CallToActionBlock)[] | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "StandingsBlock".
 */
export interface StandingsBlock {
  size?: ('small' | 'medium' | 'large') | null;
  id?: string | null;
  blockName?: string | null;
  blockType: 'standingsBlock';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
